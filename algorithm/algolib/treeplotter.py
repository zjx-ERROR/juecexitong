...
def createPlot(inTree, recall=None, precision=None, fmeasure=None, figsize=[10, 10], fname=None):
    ...
    # if fmeasure != None:
    #     col_labels = ['召回率', '准确率', 'F-Measure']
    #     table_vals = [[recall, precision, fmeasure]]
    #     plt.table(cellText=table_vals, colLabels=col_labels, cellLoc='center',colWidths=[0.1,0.1,0.1],
    #               bbox=[0.9, -0.1, 0.2, 0.1])
